 ...
 * generated in the webservicexml.exerc2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://exerc2.webservicexml/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://exerc2.webservicexml/", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservicexml.exerc2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exerc2.webservicexml/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exerc2.webservicexml/", name = "sumResponse")
